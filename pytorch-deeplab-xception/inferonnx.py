...
class Trainer(object):
    def __init__(self, args):
        ...
        # redirect stdout to output file in experiment dir
        '''
        sys.stdout = open( os.path.join(self.saver.experiment_dir, "output"), "a" )
        sys.stderr = open( os.path.join(self.saver.experiment_dir, "error"), "a" )
        '''
        ...
        '''
        model = onnxruntime.InferenceSession('deeplab-xception.onnx', None)
        model = model.run # replacing model with the run function
    ...
    def training(self, epoch):
        ...
        for i, sample in enumerate(tbar):
            ...
            # break # added this break statement to fix code glitches. it only trains the network for one sample
    ...
    def validation(self, epoch):
        ...
        for i, sample in enumerate(tbar):
            ...
            # break # added this break statement to fix code glitches. it only validates the network for one sample
    ...
    def pred_single_image(self, path, counter):
        ...
        cv2.line(rgb, (513, 0), (513, 1020), (255, 255, 255), thickness=1)
        cv2.imwrite('../xcp-run/cropweed/deeplab-resnet/experiment_0/samples/synthetic_{}.png'.format(counter), prediction)
...
def main():
    ...
    parser.add_argument('--backbone', type=str, default='resnet',
                        choices=['resnet', 'xception', 'drn', 'mobilenet', 'resnetuntrained'],
    ...
    parser.add_argument('--nir', action='store_true', default=True,
    ...
    if args.infer:
        ...
        # results.update( { "nsamples" : len(src_files) } )
